...
def hanoi4pegs(numRings, startPeg, middlePeg, endPeg, fourthPeg):
    ...
    numMoves = 0
    if numRings > 1:
        numMoves += hanoi4pegs(numRings//2, startPeg, middlePeg, fourthPeg, endPeg)
        numMoves += hanoiOffset(numRings - (numRings//2), numRings//2, startPeg, middlePeg, endPeg)
        numMoves += hanoi4pegs(numRings//2, fourthPeg, middlePeg, endPeg, startPeg)
